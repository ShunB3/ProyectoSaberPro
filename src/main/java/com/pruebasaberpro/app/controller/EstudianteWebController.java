...
public class EstudianteWebController {
	...
	public String loginFormulario(@ModelAttribute Estudiante estudiante, Model model) {
		Estudiante existsEstudiante = estudianteRepo.findByRegistro(estudiante.getRegistro());
	...
	public String verRanking(Model model) {
	    ...
	    estudiantes.forEach(estudiante -> {
	        ...
	        estudiante.setPromedio(promedio); // Suponiendo que hay un setter de promedio en Estudiante
	    });

	    // Ordenar la lista de estudiantes en orden descendente por promedio
