...
public class CoordinadorWebController {
	...
	public String editarEstudianteFormulario(@PathVariable String registro, Model model) {
		Estudiante estudiante = estudianteRepo.findByRegistro(registro);
		if (estudiante != null) {
	...
	@GetMapping("/borrar/{registro}")
    public String borrarEstudianteFormulario(@PathVariable String registro, Model model) {
         estudianteRepo.deleteByRegistro(registro);
            return "redirect:/coordinador/inicio";
    }
}
